...
Plot comparative maps of the results from the different
...
Can also plot the estimated potential GPP to get a clearer picture of the model
...
zoom_raster_pgpp <- c(mean(rue_pred), potential_gpp_mean, lgs_100$potential, lgs_1000$potential)
names(zoom_raster_pgpp) <- c("rue", "rpi", "lgs_100", "lgs_1000")

zoom_raster_pgpp <- crop(zoom_raster_pgpp, zoom_box)

zoom_rue_pgpp <- tm_shape(zoom_raster_pgpp$rue) + 
  tm_raster(
    col.scale = tm_scale_continuous(
      limits = c(0, 5000),
      values = "yl_gn",
...
zoom_rpi_pgpp <- tm_shape(zoom_raster_pgpp$rpi) + 
  tm_raster(
    col.scale = tm_scale_continuous(
      limits = c(0, 5000),
      values = "yl_gn",
...
zoom_lgs_100_pgpp <- tm_shape(zoom_raster_pgpp$lgs_100) + 
  tm_raster(
    col.scale = tm_scale_continuous(
      limits = c(0, 5000),
      values = "yl_gn",
...
zoom_lgs_1000_pgpp <- tm_shape(zoom_raster_pgpp$lgs_1000) + 
  tm_raster(
    col.scale = tm_scale_continuous(
      limits = c(0, 5000),
      values = "yl_gn",
...
tmap_save(zoom_rpi_pgpp,
          here("results", "figures", "zoom_rpi_pgpp.png"),
          width = 12, height = 12, units = "cm", dpi = 250)

tmap_save(zoom_rue_pgpp,
          here("results", "figures", "zoom_rue_pgpp.png"),
          width = 12, height = 12, units = "cm", dpi = 250)

tmap_save(zoom_lgs_100_pgpp,
          here("results", "figures", "zoom_lgs_100_pgpp.png"),
          width = 12, height = 12, units = "cm", dpi = 250)

tmap_save(zoom_lgs_1000_pgpp,
          here("results", "figures", "zoom_lgs_1000_pgpp.png"),
          width = 12, height = 12, units = "cm", dpi = 250)
