...
static_covariates <- rast(here("data", "raw", "raster", "covariateMaps", "staticVars.tif"))
...
tmap_save(rpi_mean_map, here("results", "figures", "rpi_mean_map2.png"),
          width = 12, height = 12, units = "cm", dpi = 300)
tmap_save(rpi_trend_map, here("results", "figures", "rpi_trend_map2.png"),
          width = 12, height = 12, units = "cm", dpi = 300)
tmap_save(rpi_class_map, here("results", "figures", "rpi_class_map2.png"),
          width = 12, height = 12, units = "cm", dpi = 300)
...
for (i in 1:length(bb_list)) {
  ...
  # tmap_save(
  #   rpi_mean_bb,
  #   here("results", "figures", paste0("rpi_mean_bbx", i, ".png")),
  #   width = 10, height = 10, units = "cm", dpi = 300
  # )
  # 
  # tmap_save(
  #   rpi_trend_bb,
  #   here("results", "figures", paste0("rpi_trend_bbx", i, ".png")),
  #   width = 10, height = 10, units = "cm", dpi = 300
  # )
  # 
  # tmap_save(
  #   rpi_class_bb,
  #   here("results", "figures", paste0("rpi_class_bbx", i, ".png")),
  #   width = 10, height = 10, units = "cm", dpi = 300
  # )
}
...
tmap_save(multi_panel_map, here("results", "figures", "multi_panel_class_map2.jpg"),
